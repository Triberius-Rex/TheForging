...
namespace Server.Mobiles
{
    ...
    [CorpseName("corpse of Lord Dupre")]
	public class LordDupre : BaseChampion
	{
        ...
        [Constructable]
        public LordDupre(): base(AIType.AI_Melee) 
 		{
            Name = "Dupre";
			Title = "Fallen Knight of the Virtues";
            Body = 744;
            Hue = 0x4001;
            SetStr(488, 620);
            SetDex(121, 170);
	    ...
	    SetSkill( SkillName.Tactics, 150.0 );
            ...
            AddItem(new DepravedArms2());           
            AddItem(new DepravedChest2());
            AddItem(new DepravedGloves2());
            AddItem(new DepravedLegs2());           
            AddItem(new ThighBoots());             
            AddItem(new UnHolysword());
            AddItem(new DepravedHelm2());
            AddItem(new UnholyShield());
        ...
        public override void GenerateLoot()
        {
            ...
            AddLoot(LootPack.MedScrolls, 2);
            {
                ...
                {
                    case 0: PackItem(new DepravedHelm()); break;
                    case 1: PackItem(new DepravedArms()); break;
                    case 2: PackItem(new DepravedGloves()); break;
                    case 3: PackItem(new DepravedLegs()); break;
                    case 4: PackItem(new DepravedChest()); break;
                }
            }
        ...
        public override void OnDamage(int amount, Mobile from, bool willKill)
        {
            if (from != null && !willKill && amount > 5 && from.Player && 5 > Utility.Random(10))
            {
                string[] toSay = new string[]
				{
					...
					"I've walked the world in life and undeath since the Shattering and you think you can defeat me?",    
                    "You know not who or what I have become, if you did you wouldn't be fighting still, you'd be running." 
				};
		...
		public LordDupre( Serial serial ) : base( serial )
		{
		}
