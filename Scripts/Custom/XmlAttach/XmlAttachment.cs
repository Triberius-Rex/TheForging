...
namespace Server.Engines.XmlSpawner2
{
    ...
    public abstract class XmlAttachment : IXmlAttachment
    {
        ...
        public bool DoDelete { get => false; set { if (value == true) Delete(); } }

        [CommandProperty(AccessLevel.GameMaster)]
        public int SerialValue => m_Serial.Value;

        public ASerial Serial { get => m_Serial; set => m_Serial = value; }
		...
		*/
        ...
        public virtual object AttachedTo { get => m_AttachedTo; set => m_AttachedTo = value; }

        [CommandProperty(AccessLevel.GameMaster)]
        public virtual string AttachedBy => m_AttachedBy;

        public virtual object OwnedBy { get => m_OwnedBy; set => m_OwnedBy = value; }
