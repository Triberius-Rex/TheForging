...
namespace Server.Engines.XmlSpawner2
{
    ...
    public class XmlAttach
    {
        ...
        private static readonly List<XmlAttachment> UnassignedAttachments = new List<XmlAttachment>();

        public static bool HasAttachments(object o)
        {
            if (o == null) return false;

            if (o is Item && ItemAttachments.TryGetValue((Item)o, out List<XmlAttachment> alist))//.Contains(o))
            {
        ...
        {
            if (o == null || attachments == null || o.Deleted || !attachments.TryGetValue(o, out List<XmlAttachment> list) || list == null) return null;
        ...
        private static void Defrag(Dictionary<Item, List<XmlAttachment>> attachments, Item o)
        {
            ...
            if (ItemAttachments.TryGetValue(o, out List<XmlAttachment> list))
                removeall = o.Deleted;
        ...
        private static void Defrag(Dictionary<Mobile, List<XmlAttachment>> attachments, Mobile o)
        {
            if (o == null || attachments == null) return;
            bool removeall = false;
            if (MobileAttachments.TryGetValue(o, out List<XmlAttachment> list))
                removeall = o.Deleted;
        ...
        public static void AddAttachmentProperties(object parent, ObjectPropertyList list)
        {
            ...
            if (propstr != null && list != null)
				list.Add("<BASEFONT COLOR=#30FF9B>" + propstr );
