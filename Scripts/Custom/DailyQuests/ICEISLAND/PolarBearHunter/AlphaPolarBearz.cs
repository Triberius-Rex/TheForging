...
{
    [CorpseName("a Alpine Polar Bear corpse")]
    public class AlphaPolarBearz : Troglodyte
    {
        [Constructable]
        public AlphaPolarBearz()
        {
            Name = "Alpine Polar Bear";
            Hue = 1153;
			BodyValue = 213;
        ...
        public AlphaPolarBearz(Serial serial)
            : base(serial)
        {
        }
