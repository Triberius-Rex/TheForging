...
{
    [CorpseName("a Rang Shim Bombo Yeti corpse")]
    public class RangShimBomboYeti : BaseCreature
    {
        ...
        [Constructable]
        public RangShimBomboYeti()
            : base(AIType.AI_NecroMage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Name = "Rang Shim Bombo Yeti";
			...
			PackItem( new RangShimBomboHead() );
        }

        public RangShimBomboYeti(Serial serial)
            : base(serial)
        {
        }
