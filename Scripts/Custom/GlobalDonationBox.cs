...
namespace Server.Commands
{
	public class DonationSystem
	{
		...
		public static bool CanBeGloballyAccessed = true; // Can players use commands to get items from the box wherever they are?
		...
		public class AutoOrganizer : Timer
		{
			...
			protected override void OnTick()
			{
				...
				foreach (Item item in itemlist)
				{
					...
					if ( item is BaseWeapon || item is BaseRanged || item is BaseWand )
						name = "Weapons";
